...
const Page: React.FC = () => {
  return (
    ...
    >
      ...
      This page is, by default, mapped to route '/02'. Feel free to modify this example however you'd like!
    </Explainer>
  )
}
 ...
 */
const Sample02Wrapper: React.FC = () => {
  return <MenuWrap active='Page 02'><Page /></MenuWrap>
}

export default Sample02Wrapper
